  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-[#E0E0E0] dark:border-gray-700 p-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Overall Level</h3>
          {level ? (
            <p
            ...
            <p className="text-lg text-gray-400 dark:text-gray-500 mt-1">Not rated yet</p>
          )}
        </div>

        <div className="text-right">
          <p className="text-sm text-gray-500 dark:text-gray-400">Exercises Rated</p>
          <p className="text-xl font-semibold text-[#2C3E50] dark:text-gray-100 mt-1">
